...
export default {
  ...
  "Temas": "Themes",
  "Temas de cor": "Color themes",
  "O tema de ícones de arquivo Symbols, o mesmo do VS Code": "The Symbols file icon theme, the same as VS Code's",
  "Os ícones originais do tema Symbols (miguelsolorio/vscode-symbols), embutidos no Yard: árvore de arquivos, Busca e abas passam a usar os SVGs e o mapeamento oficiais — mais de 350 ícones, com pastas nomeadas (src, docs, node_modules…). Desligada, a árvore volta ao contrato original: só o git colore.": "The original icons of the Symbols theme (miguelsolorio/vscode-symbols), bundled into Yard: the file tree, Search and the tabs switch to the official SVGs and mapping — more than 350 icons, with named folders (src, docs, node_modules…). Turned off, the tree goes back to the original contract: only git colors it.",
  "O tema de ícones mais usado do VS Code, o oficial": "VS Code's most used icon theme, the official one",
  "Os ícones originais do Material Icon Theme (PKief/vscode-material-icon-theme): 1250 ícones e o mapeamento oficial completo — milhares de nomes de arquivo e de pasta, com variante de pasta aberta. Só um tema de ícones fica ativo por vez.": "The original icons of the Material Icon Theme (PKief/vscode-material-icon-theme): 1250 icons and the complete official mapping — thousands of file and folder names, with an open-folder variant. Only one icon theme is active at a time.",
  "Tema de cor para o terminal e a sintaxe do editor": "Color theme for the terminal and the editor's syntax",
  "Recolore o conteúdo — os 16 tons ANSI, fundo e cursor dos terminais, e as cores de sintaxe do editor e dos diffs de código. O cromo do Yard continua o mesmo: tema é cor de conteúdo, não de moldura. Só um tema de cor fica ativo por vez; desligar todos volta à paleta padrão do Yard.": "Recolors the content — the 16 ANSI tones, background and cursor of the terminals, and the syntax colors of the editor and of the code diffs. Yard's chrome stays the same: a theme is content color, not frame color. Only one color theme is active at a time; turning them all off returns to Yard's default palette.",
  "Fontes de código": "Code fonts",
  "Dez famílias monoespaçadas embutidas, a maioria com ligaduras": "Ten bundled monospaced families, most with ligatures",
  "JetBrains Mono, Fira Code, Victor Mono, IBM Plex Mono, Monaspace Neon, Iosevka, Source Code Pro, Commit Mono, Geist Mono e Intel One Mono empacotadas no Yard (via Fontsource) — aparecem nos seletores das Preferências sem instalar nada no Windows, e valem para o terminal, o editor e os diffs.": "JetBrains Mono, Fira Code, Victor Mono, IBM Plex Mono, Monaspace Neon, Iosevka, Source Code Pro, Commit Mono, Geist Mono and Intel One Mono packaged into Yard (via Fontsource) — they show up in the Preferences pickers without installing anything on Windows, and apply to the terminal, the editor and the diffs.",
  "Parênteses arco-íris": "Rainbow brackets",
  "Cada nível de ( ) [ ] { } numa cor, no editor de código": "Each level of ( ) [ ] { } in a color, in the code editor",
  "Colore os pares pela profundidade do aninhamento, em cinco cores que se repetem — o par em volta do cursor continua com o realce azul de sempre. Usa a gramática do arquivo: colchete dentro de string ou comentário não conta.": "Colors the pairs by nesting depth, in five repeating colors — the pair around the cursor keeps the usual blue highlight. Uses the file's grammar: a bracket inside a string or a comment does not count.",
  "Realce de TODO": "TODO highlight",
  "TODO, FIXME, HACK e NOTE saltam aos olhos no editor": "TODO, FIXME, HACK and NOTE jump out in the editor",
  "Marca as palavras de pendência no texto do arquivo: TODO em âmbar, FIXME e BUG em vermelho, HACK e XXX em laranja, NOTE em azul — cada uma como uma pequena etiqueta, fácil de varrer ao rolar o arquivo.": "Marks the pending-work words in the file's text: TODO in amber, FIXME and BUG in red, HACK and XXX in orange, NOTE in blue — each as a small tag, easy to scan while scrolling the file.",
  "O arquivo inteiro em miniatura, na borda direita do editor": "The whole file in miniature, on the editor's right edge",
  "A visão de pássaro clássica das IDEs: blocos de texto em miniatura com a janela visível marcada, para navegar arquivo grande arrastando. Extensão @replit/codemirror-minimap, embutida.": "The classic bird's-eye view of IDEs: blocks of text in miniature with the visible window marked, to navigate a large file by dragging. Extension @replit/codemirror-minimap, bundled.",
  "Guias de indentação": "Indent guides",
  "Linhas verticais marcando cada nível de recuo no editor": "Vertical lines marking each indent level in the editor",
  "Desenha as guias que mostram onde cada bloco começa e termina, com o bloco ativo destacado — a mesma heurística do Monaco e do Ace. Extensão @replit/codemirror-indentation-markers, embutida.": "Draws the guides that show where each block starts and ends, with the active block highlighted — the same heuristic as Monaco's and Ace's. Extension @replit/codemirror-indentation-markers, bundled.",
  "Cores no CSS": "Colors in CSS",
  "Um seletor de cor ao lado de cada #hex e rgb() no código": "A color picker beside each #hex and rgb() in the code",
  "Todo valor de cor num arquivo CSS/SCSS ganha um quadradinho com a cor real, clicável para trocar pelo seletor do sistema. Extensão @replit/codemirror-css-color-picker, embutida.": "Every color value in a CSS/SCSS file gets a small square with the real color, clickable to swap it through the system picker. Extension @replit/codemirror-css-color-picker, bundled.",
  "Formatar ao salvar": "Format on save",
  "Ctrl+S formata o arquivo com o Prettier antes de gravar": "Ctrl+S formats the file with Prettier before writing",
  "JS, TS, JSX, JSON, CSS, SCSS, HTML, Markdown e YAML passam pelo Prettier embutido no salvamento — o cursor fica onde estava e o undo desfaz a formatação como qualquer edição. Arquivo com erro de sintaxe é salvo como está, sem bloquear.": "JS, TS, JSX, JSON, CSS, SCSS, HTML, Markdown and YAML go through the bundled Prettier on save — the cursor stays where it was and undo reverts the formatting like any edit. A file with a syntax error is saved as is, without blocking.",
  "Imagens no terminal": "Images in the terminal",
  "Protocolos sixel e iTerm desenham imagens no scrollback": "The sixel and iTerm protocols draw images in the scrollback",
  "CLIs que emitem imagens (gráficos de ferramentas, previews, o timg/chafa da vida) passam a desenhá-las de verdade dentro do terminal. Addon oficial @xterm/addon-image, embutido.": "CLIs that emit images (tool charts, previews, the odd timg/chafa) start drawing them for real inside the terminal. Official addon @xterm/addon-image, bundled.",
  "Diagramas Mermaid": "Mermaid diagrams",
  "Blocos ```mermaid viram diagramas de verdade no markdown": "```mermaid blocks become real diagrams in markdown",
  "Fluxogramas, sequências e afins que os agentes escrevem em markdown são renderizados na leitura e no modo dividido do editor — com sanitização estrita e o texto original a um clique. Bloco com erro de sintaxe continua aparecendo como código.": "Flowcharts, sequences and the like that agents write in markdown are rendered in the editor's read and split modes — with strict sanitization and the original text one click away. A block with a syntax error keeps showing as code.",
  "Fórmulas KaTeX": "KaTeX formulas",
  "Blocos ```math viram fórmulas renderizadas no markdown": "```math blocks become rendered formulas in markdown",
  "Notação TeX em blocos ```math (ou ```katex) é desenhada como fórmula na leitura e no modo dividido. Fórmula com erro mostra o texto original, nunca uma tela quebrada.": "TeX notation in ```math (or ```katex) blocks is drawn as a formula in the read and split modes. A formula with an error shows the original text, never a broken screen.",
