...
export const SHORTCUT_GROUPS: ShortcutGroup[] = [
  {
    ...
    items: [
      ...
      [["Ctrl", "Shift", "T"], "Reabrir a última aba de arquivo ou navegador que você fechou"],
  ...
  },
  {
    ...
    items: [
      ...
      [["Alt", "←"], "Voltar para onde você estava (Alt+→ avança de novo)"],
      [["Ctrl", "F2"], "Marcar ou desmarcar a linha"],
      [["Alt", "F2"], "Próxima marca do arquivo (Shift+Alt+F2 a anterior)"],
      [["Alt", "F5"], "Próxima mudança contra o HEAD (Shift+Alt+F5 a anterior)"],
      ...
      [["Ctrl", "."], "Correções rápidas para o problema sob o cursor (LSP)"],
  ...
  },
  {
    ...
    items: [
      ...
      [["F2"], "Renomear o cartão selecionado"],
  ...
  },
  {
    ...
    items: [
      ...
      [["Ctrl", "setas"], "Ir para o cartão naquela direção (Enter entra nele)"],
      [["setas"], "Sem nada selecionado: deslocar a tela (Shift anda 4×)"],
      [["Espaço", "arrastar"], "Mover a tela com qualquer ferramenta"],
      [["botão do meio", "arrastar"], "Mover a tela; soltar em movimento continua deslizando"],
