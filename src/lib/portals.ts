...
export const UA_CHOICES: UaChoice[] = [
  { id: "default", label: "Padrão (Chromium)", kind: "ua", engine: "webview2", group: "default" },
  { id: "chrome", label: "Chrome", kind: "ua", engine: "webview2", ua: "chrome", group: "engine" },
  { id: "firefox", label: "Firefox", kind: "ua", engine: "webview2", ua: "firefox", group: "engine" },
  { id: "msedge", label: "Microsoft Edge", kind: "ua", engine: "webview2", ua: "edge", group: "engine" },
